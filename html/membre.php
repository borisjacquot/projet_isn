...
<html>
	...
	<body background="img/bg.jpg" style="background-attachment:fixed;">
		...
		<div class="page">
			...
			<center><img class="avatar_membre" src="img/avatar.png" /></center>

			<center>
				<span class="title" style="background-image: url(img/gplay.png);">Grand gourou</span>
			</center>
			
			<h1>Succès <small>Vous avez débloqué <b>1</b> succès.</small></h1>
			<hr>
